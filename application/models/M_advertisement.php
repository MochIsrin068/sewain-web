...
class M_advertisement extends MY_Model
{
    /**
	...
	{
		parent::__construct();
        $this->tables['name'] = "advertisement";
	...
	public function create( $data )
    {
		...
		if( isset($id) )
		{
			$this->set_message('advertisement_creation_successful');
			return $id;
		}
		$this->set_error('advertisement_creation_unsuccessful');
        return FALSE;
	}
	/**
	 * update
	...
	public function update( $data, $data_param  )
    {
		...
		if ($this->db->trans_status() === FALSE)
		{
			...
			$this->set_error('advertisement_update_unsuccessful');
			return FALSE;
		}

		$this->db->trans_commit();

		$this->set_message('advertisement_update_successful');
		return TRUE;
	}
	/**
	 * delete
	...
	public function delete( $data_param  )
    {
		...
		if ($this->db->trans_status() === FALSE)
		{
			...
			$this->set_error('advertisement_delete_unsuccessful');
			return FALSE;
		}

		$this->db->trans_commit();

		$this->set_message('advertisement_delete_successful');
		return TRUE;
	}
	/**
	 * advertisement
	 ...
	 * @author madukubah
	 */
    public function advertisements( $book_id = NULL )
    {
