...
class M_mobile extends MY_Model
{
    /**
	...
	public function update( $data, $data_param  )
    {
		...
		if ($this->db->trans_status() === FALSE)
		{
			...
			$this->set_error('mobile_update_unsuccessful');
			return FALSE;
		}

		$this->db->trans_commit();

		$this->set_message('mobile_update_successful');
		return TRUE;
	}
	 ...
	 * @author madukubah
	 */
    public function mobile_settings( $book_id = NULL )
    {
